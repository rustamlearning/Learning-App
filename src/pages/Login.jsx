        ...
        <div className="w-full max-w-md px-1 py-4 sm:px-2 sm:py-6">
          <header className="mb-7">
            ...
            <p className="mt-3 text-sm leading-6 text-slate-600">
              Gunakan akun sekolah yang sudah terdaftar. Guru memakai NIP, siswa memakai nama lengkap dan password 6 digit.
            </p>
          </header>
          ...
          <form onSubmit={submit} className="space-y-4">
            <label className="grid gap-2 text-sm font-bold text-slate-700">
              ...
              <input
                ...
                placeholder="Nama lengkap, NIP, atau email sekolah"
